...
class TestNNWeightDerivatives(unittest.TestCase):
...
class TestNNPytorchADWeightDerivatives(unittest.TestCase):
    ...
    def test_resnetNN(self):
        ...
        x = self.setup_data()
        d = x.shape[1]
        f = net.NN(net.resnetNN(d, 4, act=act.softplusActivation()))
        f = net.NNPytorchAD(f)
        print(self)
        network_derivative_check(f, x, do_Hessian=True, forward_mode=True)
        network_derivative_check(f, x, do_Hessian=True, forward_mode=False)
...
# class TestNNPytorchHessianWeightDerivatives(unittest.TestCase):
# TODO: fix this test
#
#     @staticmethod
#     def setup_data():
...
#         x = self.setup_data()
#         d = x.shape[1]
#         f = net.NN(lay.singleLayer(d, 1, act=act.softplusActivation()))
#         f = net.NNPytorchHessian(f)
#
#         print(self)
#         network_derivative_check(f, x, do_Hessian=True, forward_mode=True, verbose=True)
        # network_derivative_check(f, x, do_Hessian=True, forward_mode=False)
    ...
    #     x = self.setup_data()
    #     d = x.shape[1]
    #     f = net.NN(net.resnetNN(d, 1, act=act.softplusActivation()))
    #     f = net.NNPytorchHessian(f)
    #     print(self)
    #     network_derivative_check(f, x, do_Hessian=True, forward_mode=True)
    #     network_derivative_check(f, x, do_Hessian=True, forward_mode=False)
